...
def _register_external_op_helper(op_name, supported=True):
    ...
    @tvm.ir.register_op_attr(op_name, "target.mynn")
...
def make_pattern(with_bias=True):
    ...
    return is_op("add")(conv, bias)


@register_pattern_table("mynn")
def pattern_table():
    conv2d_bias_pat = ("mynn.conv2d_bias", make_pattern(with_bias=True))
    dnnl_patterns = [conv2d_bias_pat,]
